...
TEMPLATE_DIR = os.path.join(os.path.dirname(__file__), "project_structure/project_template")
APP_TEMPLATE_DIR = os.path.join(os.path.dirname(__file__), "project_structure/app_template")
